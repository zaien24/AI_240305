...
openai.api_key = "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"
...
class SloganGenerator:
    ...
    def _infer_using_chatgpt(self, prompt):
        system_instruction = "assistant는 면접 질문 문구 작성 도우미로 동작한다. user의 내용을 참고하여 질문을 10개 작성해라"
    ...
    def generate(self, product_name, details, tone_and_manner):
        prompt = f"질문1: {product_name}\n질문2: {details}\n질문3: {tone_and_manner} 위 내용을 참고하여 질문 10개를 만들어라."
